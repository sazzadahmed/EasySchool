...
$rawQuery = "INSERT INTO `exam`( `type`, `class`, `session`, `subject`, `major`,  `mark`, `mcq`, `written`,`semester`) VALUES ($typeOfExam,'".$cls."','".$session."','".$course_code."',".$program.",$mark,$mcq_mark,$written_mark,$activeSemester)";
$db->query($rawQuery);
echo 'success';
