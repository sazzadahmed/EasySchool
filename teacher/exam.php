...
<?php if (is_teacher_Loggedin()) : ?>
    ...
    <form style="border:1px solid #dddd" id="exam_create_form_selected" onsubmit="return false">
        <div class="row" style="padding: 21px 0px;background: beige;">
            ...
            <div class="col-xs-2">
                <select required class="form-control" id="exam_class" name="class" onchange="getAllCourseListAdmin();">
            ...
            <div class="col-sm-2">
                <select class="form-control" id="exam_program" name="program" onchange="getAllCourseListAdmin()">
