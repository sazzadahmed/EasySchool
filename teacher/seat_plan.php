...
<?php if (is_teacher_Loggedin()) : ?>
    ...
    <br />
    <br />
    <h3 class="page-header">Seat Plan</h3>
    <br />
    <form style="border:1px solid #dddd" id="exam_prepare_form_selected" onsubmit="return false">
        <div class="row" style="padding: 21px 0px;background: beige;">
            ...
            <button class="btn btn-success" id='seatPlan'>Seat Plan</button>
        </div>
    </form>

    <div class="table-responsive" id="print_seatPlan">
        <table class="table table-bordered">
            <thead>
           <tr>
           <th>id</th><th>Name</th><th>Session</th><th>Section</th><th>Group</th><th>Room<th>Seat No</th> 
           </tr>
            </thead>
            <tbody id ="seat_plan_id">
